...
public class GenerateAST {
    ...
    private static void defineAst(String outputDir, String baseName, List<String> types) throws IOException {
        ...
        writer.println("/*");
        writer.println(" * This file is autogenerated using tool/GenerateAST.java");
        writer.println(" * DO NOT MODIFY DIRECTLY - MODIFICATIONS WILL BE OVERWRITTEN ON FILE GENERATION");
        writer.println(" */");
        writer.println();
        writer.println();
        writer.println("package tok;");
        writer.println();
